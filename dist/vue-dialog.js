...
/***/
function(module,exports,__webpack_require__){"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.VueDialog=void 0;var _promise=__webpack_require__(1),_promise2=_interopRequireDefault(_promise),_classCallCheck2=__webpack_require__(66),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=__webpack_require__(67),_createClass3=_interopRequireDefault(_createClass2),_vuedals=__webpack_require__(71),_vueLongpress=__webpack_require__(72),_vueLongpress2=_interopRequireDefault(_vueLongpress),_deepmerge=__webpack_require__(73),_deepmerge2=_interopRequireDefault(_deepmerge),_VueDialog=function(){function _VueDialog(){(0,_classCallCheck3.default)(this,_VueDialog)}return(0,_createClass3.default)(_VueDialog,[{key:"confirm",value:function(){var message=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"Are you sure?",params=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},defaults={title:"Please confirm",labels:{ok:"Ok",cancel:"Cancel"}},options=(0,_deepmerge2.default)(defaults,params);return new _promise2.default(function(resolve,reject){_vuedals.Bus.$emit("new",{name:"vue-dialog confirm",dismisable:!1,title:options.title,component:{name:"vue-dialog-confirm",data:function(){return{options:options,message:message}},methods:{success:function(){_vuedals.Bus.$emit("close"),resolve()},cancel:function(){_vuedals.Bus.$emit("close"),reject()}},template:'\n                        <div class="vue-dialog-content">\n                            <header v-if="options.title"{{ options.title }}</header>\n\n                            <p>{{ message }}</p>\n\n                            <div class="actions">\n                                <span @click="success()" class="btn btn-primary button-ok">{{ options.labels.ok }}</span>\n                                <span @click="cancel()" class="btn btn-default button-cancel">{{ options.labels.cancel }}</span>\n                            </div>\n                        </div>\n                    '}})})}},{key:"hardConfirm",value:function(){var message=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"To continue please type the text below",confirmationMessage=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"I really want to do it",params=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},defaults={duration:5,labels:{ok:"Yes, i'm sure",pressing:"Keep pressing...",action:"Confirmed, please wait...",cancel:"Cancel"}},options=(0,_deepmerge2.default)(defaults,params);return new _promise2.default(function(resolve,reject){_vuedals.Bus.$emit("new",{name:"vue-dialog hard-confirm",title:null,component:{name:"vue-dialog-hard-confirm",components:{Longpress:_vueLongpress2.default},data:function(){return{typed:"",options:options,message:message,confirmationMessage:confirmationMessage,confirmed:!1,progress:0}},methods:{confirm:function(){_vuedals.Bus.$emit("close"),resolve()},cancel:function(){_vuedals.Bus.$emit("close"),reject()}},watch:{typed:function(value){value=value.trim().toLowerCase();var lowerConfirmationMessage=this.confirmationMessage.trim().toLowerCase();lowerConfirmationMessage.substr(0,value.length)===value&&(this.progress=value.length/lowerConfirmationMessage.length),value===lowerConfirmationMessage?this.confirmed=!0:this.confirmed=!1}},template:'\n                        <div>\n                            <div class="message">{{ message }}</div>\n                            <div class="confirmation-message">{{ confirmationMessage }}</div>\n                            <div class="input-container">\n                                <input type="text" v-model="typed" autofocus/>\n                                <div class="typed-progress-bar">\n                                    <span :style="\'width:\'+(progress * 100)+\'%\'"></span>\n                                </div>\n                            </div>\n                            <div class="actions">\n                                <longpress class="btn btn-danger" :disabled="!confirmed" :onConfirm="confirm" :duration="options.duration" :pressingText="options.labels.pressing" :actionText="options.labels.action">{{ options.labels.ok }}</longpress>\n                                <span class="btn btn-default" @click="cancel()">{{ options.labels.cancel }}</span>\n                            </div>\n                        </div>\n                    '}})})}},{key:"alert",value:function(message){var buttonLabel=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"Ok";return new _promise2.default(function(resolve){_vuedals.Bus.$emit("new",{dismisable:!1,name:"vue-dialog alert",component:{name:"vue-dialog-alert",data:function(){return{buttonLabel:buttonLabel,message:message}},methods:{close:function(){_vuedals.Bus.$emit("close"),resolve()}},template:'\n                        <div class="vue-dialog-content">\n                            <p>{{ message }}</p>\n\n                            <div class="actions">\n                                <span @click="close()" class="btn btn-primary button-ok">{{ buttonLabel }}</span>\n                            </div>\n                        </div>\n                    '}})})}}]),_VueDialog}();exports.VueDialog=new _VueDialog},/* 1 */
/***/
function(module,exports,__webpack_require__){module.exports={default:__webpack_require__(2),__esModule:!0}},/* 2 */
/***/
function(module,exports,__webpack_require__){__webpack_require__(3),__webpack_require__(4),__webpack_require__(48),__webpack_require__(52),module.exports=__webpack_require__(12).Promise},/* 3 */
/***/
...
// Fix native
$anyNative&&(IteratorPrototype=getPrototypeOf($anyNative.call(new Base)),IteratorPrototype!==Object.prototype&&(
...
/***/
function(module,exports){var core=module.exports={version:"2.4.0"};"number"==typeof __e&&(__e=core)},/* 13 */
/***/
...
// false -> Array#indexOf
// true  -> Array#includes
var toIObject=__webpack_require__(33),toLength=__webpack_require__(37),toIndex=__webpack_require__(38);module.exports=function(IS_INCLUDES){return function($this,el,fromIndex){var value,O=toIObject($this),length=toLength(O.length),index=toIndex(fromIndex,length);
// Array#includes uses SameValueZero equality algorithm
if(IS_INCLUDES&&el!=el){for(;length>index;)if(value=O[index++],value!=value)return!0}else for(;length>index;index++)if((IS_INCLUDES||index in O)&&O[index]===el)return IS_INCLUDES||index||0;return!IS_INCLUDES&&-1}}},/* 37 */
/***/
function(module,exports,__webpack_require__){
// 7.1.15 ToLength
...
/***/
function(module,exports,__webpack_require__){module.exports=__webpack_require__(11).document&&document.documentElement},/* 44 */
/***/
...
/***/
function(module,exports,__webpack_require__){"use strict";var Internal,GenericPromiseCapability,Wrapper,LIBRARY=__webpack_require__(9),global=__webpack_require__(11),ctx=__webpack_require__(13),classof=__webpack_require__(53),$export=__webpack_require__(10),isObject=__webpack_require__(18),aFunction=__webpack_require__(14),anInstance=__webpack_require__(54),forOf=__webpack_require__(55),speciesConstructor=__webpack_require__(59),task=__webpack_require__(60).set,microtask=__webpack_require__(62)(),PROMISE="Promise",TypeError=global.TypeError,process=global.process,$Promise=global[PROMISE],process=global.process,isNode="process"==classof(process),empty=function(){},USE_NATIVE=!!function(){try{
...
$Promise=function(executor){anInstance(this,$Promise,PROMISE,"_h"),aFunction(executor),Internal.call(this);try{executor(ctx($resolve,this,1),ctx($reject,this,1))}catch(err){$reject.call(this,err)}},Internal=function(executor){this._c=[],// <- awaiting reactions
this._a=void 0,// <- checked in isUnhandled reactions
this._s=0,// <- state
this._d=!1,// <- done
this._v=void 0,// <- value
this._h=0,// <- rejection state, 0 - default, 1 - handled, 2 - unhandled
this._n=!1},Internal.prototype=__webpack_require__(63)($Promise.prototype,{
...
catch:function(onRejected){return this.then(void 0,onRejected)}}),PromiseCapability=function(){var promise=new Internal;this.promise=promise,this.resolve=ctx($resolve,promise,1),this.reject=ctx($reject,promise,1)}),$export($export.G+$export.W+$export.F*!USE_NATIVE,{Promise:$Promise}),__webpack_require__(44)($Promise,PROMISE),__webpack_require__(64)(PROMISE),Wrapper=__webpack_require__(12)[PROMISE],
// statics
...
if(x instanceof $Promise&&sameConstructor(x.constructor,this))return x;var capability=newPromiseCapability(this),$$resolve=capability.resolve;return $$resolve(x),capability.promise}}),$export($export.S+$export.F*!(USE_NATIVE&&__webpack_require__(65)(function(iter){$Promise.all(iter).catch(empty)})),PROMISE,{
// 25.4.4.1 Promise.all(iterable)
all:function(iterable){var C=this,capability=newPromiseCapability(C),resolve=capability.resolve,reject=capability.reject,abrupt=perform(function(){var values=[],index=0,remaining=1;forOf(iterable,!1,function(promise){var $index=index++,alreadyCalled=!1;values.push(void 0),remaining++,C.resolve(promise).then(function(value){alreadyCalled||(alreadyCalled=!0,values[$index]=value,--remaining||resolve(values))},reject)}),--remaining||resolve(values)});return abrupt&&reject(abrupt.error),capability.promise},
// 25.4.4.4 Promise.race(iterable)
race:function(iterable){var C=this,capability=newPromiseCapability(C),reject=capability.reject,abrupt=perform(function(){forOf(iterable,!1,function(promise){C.resolve(promise).then(capability.resolve,reject)})});return abrupt&&reject(abrupt.error),capability.promise}})},/* 53 */
/***/
function(module,exports,__webpack_require__){
...
/***/
function(module,exports,__webpack_require__){var defer,channel,port,ctx=__webpack_require__(13),invoke=__webpack_require__(61),html=__webpack_require__(43),cel=__webpack_require__(22),global=__webpack_require__(11),process=global.process,setTask=global.setImmediate,clearTask=global.clearImmediate,MessageChannel=global.MessageChannel,counter=0,queue={},ONREADYSTATECHANGE="onreadystatechange",run=function(){var id=+this;if(queue.hasOwnProperty(id)){var fn=queue[id];delete queue[id],fn()}},listener=function(event){run.call(event.data)};
// Node.js 0.9+ & IE10+ has setImmediate, otherwise:
setTask&&clearTask||(setTask=function(fn){for(var args=[],i=1;arguments.length>i;)args.push(arguments[i++]);return queue[++counter]=function(){invoke("function"==typeof fn?fn:Function(fn),args)},defer(counter),counter},clearTask=function(id){delete queue[id]},
// Node.js 0.8-
"process"==__webpack_require__(35)(process)?defer=function(id){process.nextTick(ctx(run,id,1))}:MessageChannel?(channel=new MessageChannel,port=channel.port2,channel.port1.onmessage=listener,defer=ctx(port.postMessage,port,1)):global.addEventListener&&"function"==typeof postMessage&&!global.importScripts?(defer=function(id){global.postMessage(id+"","*")},global.addEventListener("message",listener,!1)):defer=ONREADYSTATECHANGE in cel("script")?function(id){html.appendChild(cel("script"))[ONREADYSTATECHANGE]=function(){html.removeChild(this),run.call(id)}}:function(id){setTimeout(ctx(run,id,1),0)}),module.exports={set:setTask,clear:clearTask}},/* 61 */
/***/
function(module,exports){
...
/***/
function(module,exports,__webpack_require__){var hide=__webpack_require__(15);module.exports=function(target,src,safe){for(var key in src)safe&&target[key]?target[key]=src[key]:hide(target,key,src[key]);return target}},/* 64 */
/***/
function(module,exports,__webpack_require__){"use strict";var global=__webpack_require__(11),core=__webpack_require__(12),dP=__webpack_require__(16),DESCRIPTORS=__webpack_require__(20),SPECIES=__webpack_require__(45)("species");module.exports=function(KEY){var C="function"==typeof core[KEY]?core[KEY]:global[KEY];DESCRIPTORS&&C&&!C[SPECIES]&&dP.f(C,SPECIES,{configurable:!0,get:function(){return this}})}},/* 65 */
/***/
function(module,exports,__webpack_require__){var ITERATOR=__webpack_require__(45)("iterator"),SAFE_CLOSING=!1;try{var riter=[7][ITERATOR]();riter.return=function(){SAFE_CLOSING=!0},Array.from(riter,function(){throw 2})}catch(e){}module.exports=function(exec,skipClosing){if(!skipClosing&&!SAFE_CLOSING)return!1;var safe=!1;try{var arr=[7],iter=arr[ITERATOR]();iter.next=function(){return{done:safe=!0}},arr[ITERATOR]=function(){return iter},exec(arr)}catch(e){}return safe}},/* 66 */
/***/
function(module,exports){"use strict";exports.__esModule=!0,exports.default=function(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}},/* 67 */
/***/
function(module,exports,__webpack_require__){"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}exports.__esModule=!0;var _defineProperty=__webpack_require__(68),_defineProperty2=_interopRequireDefault(_defineProperty);exports.default=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),(0,_defineProperty2.default)(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}()},/* 68 */
/***/
function(module,exports,__webpack_require__){module.exports={default:__webpack_require__(69),__esModule:!0}},/* 69 */
/***/
function(module,exports,__webpack_require__){__webpack_require__(70);var $Object=__webpack_require__(12).Object;module.exports=function(it,key,desc){return $Object.defineProperty(it,key,desc)}},/* 70 */
/***/
function(module,exports,__webpack_require__){var $export=__webpack_require__(10);
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S+$export.F*!__webpack_require__(20),"Object",{defineProperty:__webpack_require__(16).f})},/* 71 */
/***/
function(module,exports,__webpack_require__){/*!
